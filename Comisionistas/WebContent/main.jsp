...
<body>
	<div id="header">
		<table cellpadding="20" width="100%">
			<tr>
				...
				<td><h1>&nbsp;<br>Administrador de Comisionistas</h1></td>
			</tr>
	...
	<div id="tabs">
		<ul>
			...
			<li><a href="resources/seguridad.jsf">Seguridad</a></li>
			<li><a href="resources/reportes.jsf">Reportes</a></li>
		</ul>
		<div id="tabs-1">
			<div style="text-align: center;">
			<p><strong  class="ui-state-highlight ui-corner-all">&nbsp;&nbsp;&nbsp;Bienvenido&nbsp;&nbsp;&nbsp;</strong></p>
				<iframe src="resources/bolson.jsf" width="100%" frameborder="0" height="350px"></iframe>
			</div>
		</div>
	</div>
